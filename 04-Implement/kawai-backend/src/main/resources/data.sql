...
-- Mật khẩu cho Tourguide: "admin123" (BCrypt hash)
INSERT INTO Accounts (account_id, username, password_hash, is_active, role_id, created_at)
VALUES (13, 'tourguide', '$2a$10$4bnThA4xQVw1rF2POQv78uAQll2KsUsgF32JaYiVG5d2d3Fhgk83q', TRUE, 7, CURRENT_TIMESTAMP);
-- ── 3. Employees ─────────────────────────────────────────────
...
INSERT INTO Employees (employee_id, account_id, full_name, gender, cccd, phone, email, salary)
VALUES (5, 13, 'Nguyễn Hướng Dẫn', 'Nam', '001234567894', '0912000005', 'guide@hoanien.vn', 8000000);
-- ── 4. Room Categories ───────────────────────────────────────
UPDATE Room_Categories SET category_name = 'Nipa Pool Villa', base_price = 2500000, capacity = 2 WHERE category_id = 1;
UPDATE Room_Categories SET category_name = 'River Pool Villa', base_price = 3500000, capacity = 3 WHERE category_id = 2;
UPDATE Room_Categories SET category_name = 'Wellness Retreats', base_price = 8000000, capacity = 4 WHERE category_id = 3;

INSERT INTO Room_Categories (category_id, category_name, base_price, capacity)
VALUES (1, 'Nipa Pool Villa', 2500000, 2);
INSERT INTO Room_Categories (category_id, category_name, base_price, capacity)
VALUES (2, 'River Pool Villa', 3500000, 3);
INSERT INTO Room_Categories (category_id, category_name, base_price, capacity)
VALUES (3, 'Wellness Retreats', 8000000, 4);
-- ── 5. Rooms ─────────────────────────────────────────────────
...
-- Lịch trình hôm nay (2026-06-13)
INSERT INTO Tour_Schedules (schedule_id, tour_id, departure_date, departure_time, booked_seats, schedule_status)
VALUES (5, 2, '2026-06-13', '08:00:00', 2, 'Open');

-- Đăng ký Booking Tour cho Nam và An hôm nay
INSERT INTO Bookings (booking_id, customer_id, booking_date, total_price, booking_status, booking_source, version)
VALUES (9, 1, '2026-06-10', 1200000, 'Confirmed', 'Direct_Web', 1);
INSERT INTO Tour_Bookings (booking_id, schedule_id, participant_count, is_walk_in_tour)
VALUES (9, 5, 1, FALSE);

INSERT INTO Bookings (booking_id, customer_id, booking_date, total_price, booking_status, booking_source, version)
VALUES (10, 2, '2026-06-10', 1200000, 'Confirmed', 'Direct_Web', 1);
INSERT INTO Tour_Bookings (booking_id, schedule_id, participant_count, is_walk_in_tour)
VALUES (10, 5, 1, FALSE);

-- Danh sach hanh khach di tour hom nay
INSERT INTO Tour_Attendees (attendee_id, tour_booking_id, customer_id, dependent_id, attendance_status, face_matched_at, face_vector_data)
VALUES (1, 9, 1, NULL, 'Not_Show', NULL, NULL);

INSERT INTO Tour_Attendees (attendee_id, tour_booking_id, customer_id, dependent_id, attendance_status, face_matched_at, face_vector_data)
VALUES (2, 10, 2, NULL, 'Not_Show', NULL, NULL);

-- Them khach demo cho face recognition (dung chung anh me.jpg)
...
(9, NULL, 'Luu Dinh Duc', 'Nam', 'CCCD_DEMO1', '0909990001', 'duc@test.com', 0, 'Regular'),
(10, NULL, 'Nguyen Minh Duc', 'Nam', 'CCCD_DEMO2', '0909990002', 'duc2@test.com', 0, 'Regular'),
(11, NULL, 'Tran Thi Mai', 'Nu', 'CCCD_DEMO3', '0909990003', 'mai@test.com', 0, 'Regular');

INSERT IGNORE INTO Bookings (booking_id, customer_id, booking_date, total_price, booking_status, booking_source, version) VALUES
(11, 9, '2026-06-12', 1200000, 'Confirmed', 'Direct_Web', 1),
(12, 10, '2026-06-12', 1200000, 'Confirmed', 'Direct_Web', 1),
(13, 11, '2026-06-12', 1200000, 'Confirmed', 'Direct_Web', 1);

INSERT IGNORE INTO Tour_Bookings (booking_id, schedule_id, participant_count, is_walk_in_tour) VALUES
(11, 5, 1, FALSE),
(12, 5, 1, FALSE),
(13, 5, 1, FALSE);

INSERT IGNORE INTO Tour_Attendees (attendee_id, tour_booking_id, customer_id, dependent_id, attendance_status, face_matched_at, face_vector_data) VALUES
(3, 11, 9, NULL, 'Not_Show', NULL, NULL),
(4, 12, 10, NULL, 'Not_Show', NULL, NULL),
(5, 13, 11, NULL, 'Not_Show', NULL, NULL);

-- Cap nhat so luong cho da dat
UPDATE Tour_Schedules SET booked_seats = 5 WHERE schedule_id = 5;
...
INSERT INTO Authorized_Devices (device_code, is_approved) VALUES ('HN-2ZMIZIICB-6W7ITHEVD', true);
