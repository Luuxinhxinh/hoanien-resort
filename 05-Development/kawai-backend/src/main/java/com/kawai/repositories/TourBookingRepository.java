...
public interface TourBookingRepository extends JpaRepository<TourBooking, Long> {
    ...
    java.math.BigDecimal revenueOnDate(@org.springframework.data.repository.query.Param("date") java.time.LocalDate date);
    ...
    java.math.BigDecimal revenueBetween(@org.springframework.data.repository.query.Param("start") java.time.LocalDate start, @org.springframework.data.repository.query.Param("end") java.time.LocalDate end);
