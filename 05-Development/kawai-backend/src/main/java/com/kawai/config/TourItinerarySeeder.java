...
public class TourItinerarySeeder implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        // 1. Cập nhật thông tin cơ bản cho 10 Tours (basePrice, duration, maxCapacity, slogans, descriptions)
        jdbcTemplate.execute("UPDATE Tours SET base_price = 7500000, duration = '10 Giờ', max_capacity = 15, short_quote = 'Tìm về hơi ấm vẹn nguyên của lòng biết ơn và sự gắn kết.', description = 'Chuyến đi đưa bạn ngược dòng thời gian về với nét đẹp trầm mặc của cố đô, khơi mở những câu chuyện di sản và thưởng thức phong vị ẩm thực cung đình xưa.' WHERE tour_id = 1");
        jdbcTemplate.execute("UPDATE Tours SET base_price = 5800000, duration = '10 Giờ', max_capacity = 12, short_quote = 'Lắng nghe nhịp điệu mộc mạc của đất mẹ và hồn quê xứ Quảng.', description = 'Hành trình chạm vào những điều bình dị mà sâu lắng của đất Quảng: từ những con phố rêu phong ở Hội An, hương đất nung bên dòng sông Thu Bồn đến vị mặn mòi của một làng rau lâu đời.' WHERE tour_id = 2");
        jdbcTemplate.execute("UPDATE Tours SET base_price = 6500000, duration = '10 Giờ', max_capacity = 12, short_quote = 'Chạm vào hồn cốt của thời gian qua những tạo tác từ đôi bàn tay nghệ nhân.', description = 'Hành trình tìm về vẻ đẹp sơn thủy hữu tình của vùng đất cố đô cổ kính, nơi bạn được trò chuyện và cùng các nghệ nhân lưu giữ những làng nghề truyền thống trăm năm.' WHERE tour_id = 3");
        jdbcTemplate.execute("UPDATE Tours SET base_price = 8200000, duration = '10 Giờ', max_capacity = 8, short_quote = 'Sự thanh lọc thuần khiết cho thân - tâm - trí giữa vùng sông nước mờ sương.', description = 'Một ngày trốn khỏi phố thị để về với đại đầm sen, mượn hương hoa và sóng nước miền Tây làm dịu lại tâm hồn, tìm lại sự bình an sâu lắng bên trong bạn.' WHERE tour_id = 4");
        jdbcTemplate.execute("UPDATE Tours SET base_price = 7500000, duration = '10 Giờ', max_capacity = 15, short_quote = 'Du thuyền lướt nhẹ giữa ngàn khơi, thưởng ngoạn kỳ quan thiên nhiên rực rỡ.', description = 'Chuyến hải trình thong dong đưa bạn lướt qua những đảo đá nhấp nhô của vịnh Bắc Bộ, khám phá thế giới thạch nhũ kỳ vĩ được tạo hóa giấu kín ngàn năm và đón hoàng hôn buông trên mặt biển.' WHERE tour_id = 5");
        jdbcTemplate.execute("UPDATE Tours SET base_price = 8200000, duration = '11 Giờ', max_capacity = 10, short_quote = 'Gặp gỡ những nụ cười hồn hậu giữa vùng mây trời sương phủ.', description = 'Hành trình dạo bước qua những nấc thang ruộng bậc thang xanh mướt tại bản Cát Cát, tìm hiểu cuộc sống mộc mạc của đồng bào người H''Mông và lắng lại tâm hồn giữa núi rừng Tây Bắc.' WHERE tour_id = 6");
        jdbcTemplate.execute("UPDATE Tours SET base_price = 9500000, duration = '14 Giờ', max_capacity = 8, short_quote = 'Lắng nghe tiếng gọi thì thầm từ đại ngàn xanh thẳm.', description = 'Chuyến băng rừng rậm Nam Cát Tiên đầy cảm xúc, đưa bạn ghé thăm đầm lầy bảo tồn tự nhiên, thưởng thức bữa tối bên rừng và trải nghiệm ngắm thú đêm hoang dã.' WHERE tour_id = 7");
        jdbcTemplate.execute("UPDATE Tours SET base_price = 6500000, duration = '11 Giờ', max_capacity = 10, short_quote = 'Đón những vệt nắng đầu ngày rực rỡ trên sa mạc cát mênh mông.', description = 'Trải nghiệm cảm giác phấn khích vượt đồi cát bằng xe ATV đón bình minh, khám phá dòng suối Tiên huyền thoại và thưởng thức mỹ vị biển khơi.' WHERE tour_id = 8");
        jdbcTemplate.execute("UPDATE Tours SET base_price = 8500000, duration = '10 Giờ', max_capacity = 12, short_quote = 'Hòa mình vào làn nước xanh lục bảo và vũ điệu rực rỡ dưới lòng đại dương.', description = 'Đồng hành cùng cano cao cấp lướt qua những hòn đảo hoang sơ, lặn ngắm rạn san hô đa sắc màu và tận hưởng bữa chiều ngắm hoàng hôn lãng mạn trên biển.' WHERE tour_id = 9");
        jdbcTemplate.execute("UPDATE Tours SET base_price = 6800000, duration = '10 Giờ', max_capacity = 12, short_quote = 'Tròn vị ngọt ngào của trái chín trĩu cành miền sông nước.', description = 'Đón bình minh trên chiếc ghe máy mộc mạc phục vụ riêng, hòa mình vào chợ nổi Cái Răng sầm uất, khám phá miệt vườn trĩu quả và học làm bánh dân gian Nam Bộ.' WHERE tour_id = 10");
