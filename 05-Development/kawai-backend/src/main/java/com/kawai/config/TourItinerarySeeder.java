...
public class TourItinerarySeeder implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        jdbcTemplate.execute("INSERT IGNORE INTO Tours (tour_id, tour_name, tour_type, base_price, max_capacity, duration, duration_hours, is_insurance_required, insurance_price, short_quote, description, is_active) VALUES (1, 'Hành trình Cố đô', 'CULTURAL', 7500000, 15, '10 Giờ', 10.0, TRUE, 50000, 'Tìm về hơi ấm vẹn nguyên của lòng biết ơn và sự gắn kết.', 'Chuyến đi đưa bạn ngược dòng thời gian về với nét đẹp trầm mặc của cố đô, khơi mở những câu chuyện di sản và thưởng thức phong vị ẩm thực cung đình xưa.', TRUE)");
        jdbcTemplate.execute("INSERT IGNORE INTO Tours (tour_id, tour_name, tour_type, base_price, max_capacity, duration, duration_hours, is_insurance_required, insurance_price, short_quote, description, is_active) VALUES (2, 'Hồn Quê Xứ Quảng', 'CULTURAL', 5800000, 12, '10 Giờ', 10.0, TRUE, 50000, 'Lắng nghe nhịp điệu mộc mạc của đất mẹ và hồn quê xứ Quảng.', 'Hành trình chạm vào những điều bình dị mà sâu lắng của đất Quảng: từ những con phố rêu phong ở Hội An, hương đất nung bên dòng sông Thu Bồn đến vị mặn mòi của một làng rau lâu đời.', TRUE)");
        jdbcTemplate.execute("INSERT IGNORE INTO Tours (tour_id, tour_name, tour_type, base_price, max_capacity, duration, duration_hours, is_insurance_required, insurance_price, short_quote, description, is_active) VALUES (3, 'Hồn Đất Văn Lâm', 'CULTURAL', 6500000, 12, '10 Giờ', 10.0, TRUE, 50000, 'Chạm vào hồn cốt của thời gian qua những tạo tác từ đôi bàn tay nghệ nhân.', 'Hành trình tìm về vẻ đẹp sơn thủy hữu tình của vùng đất cố đô cổ kính, nơi bạn được trò chuyện và cùng các nghệ nhân lưu giữ những làng nghề truyền thống trăm năm.', TRUE)");
        jdbcTemplate.execute("INSERT IGNORE INTO Tours (tour_id, tour_name, tour_type, base_price, max_capacity, duration, duration_hours, is_insurance_required, insurance_price, short_quote, description, is_active) VALUES (4, 'Thiền Giữa Hương Sen', 'RELAX', 8200000, 8, '10 Giờ', 10.0, TRUE, 50000, 'Sự thanh lọc thuần khiết cho thân - tâm - trí giữa vùng sông nước mờ sương.', 'Một ngày trốn khỏi phố thị để về với đại đầm sen, mượn hương hoa và sóng nước miền Tây làm dịu lại tâm hồn, tìm lại sự bình an sâu lắng bên trong bạn.', TRUE)");
        jdbcTemplate.execute("INSERT IGNORE INTO Tours (tour_id, tour_name, tour_type, base_price, max_capacity, duration, duration_hours, is_insurance_required, insurance_price, short_quote, description, is_active) VALUES (5, 'Vịnh Xanh Kì Vĩ', 'ADVENTURE', 7500000, 15, '10 Giờ', 10.0, TRUE, 50000, 'Du thuyền lướt nhẹ giữa ngàn khơi, thưởng ngoạn kỳ quan thiên nhiên rực rỡ.', 'Chuyến hải trình thong dong đưa bạn lướt qua những đảo đá nhấp nhô của vịnh Bắc Bộ, khám phá thế giới thạch nhũ kỳ vĩ được tạo hóa giấu kín ngàn năm và đón hoàng hôn buông trên mặt biển.', TRUE)");
        ...
        jdbcTemplate.execute("INSERT IGNORE INTO Tours (tour_id, tour_name, tour_type, base_price, max_capacity, duration, duration_hours, is_insurance_required, insurance_price, short_quote, description, is_active) VALUES (7, 'Khám Phá Rừng Xanh', 'ADVENTURE', 9500000, 8, '14 Giờ', 14.0, TRUE, 50000, 'Lắng nghe tiếng gọi thì thầm từ đại ngàn xanh thẳm.', 'Chuyến băng rừng rậm Nam Cát Tiên đầy cảm xúc, đưa bạn ghé thăm đầm lầy bảo tồn tự nhiên, thưởng thức bữa tối bên rừng và trải nghiệm ngắm thú đêm hoang dã.', TRUE)");
