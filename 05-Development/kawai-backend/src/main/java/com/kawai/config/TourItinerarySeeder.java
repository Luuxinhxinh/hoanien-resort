...
public class TourItinerarySeeder implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        jdbcTemplate.execute("INSERT IGNORE INTO Tours (tour_id, tour_name, tour_type, base_price, max_capacity, duration, duration_hours, is_insurance_required, insurance_price, short_quote, description, is_active) VALUES (1, 'Hành trình Cố đô', 'CULTURAL', 7500000, 15, '10 Giờ', 10.0, FALSE, 0, 'Tìm về hơi ấm vẹn nguyên của lòng biết ơn và sự gắn kết.', 'Chuyến đi đưa bạn ngược dòng thời gian về với nét đẹp trầm mặc của cố đô, khơi mở những câu chuyện di sản và thưởng thức phong vị ẩm thực cung đình xưa.', TRUE)");
        jdbcTemplate.execute("INSERT IGNORE INTO Tours (tour_id, tour_name, tour_type, base_price, max_capacity, duration, duration_hours, is_insurance_required, insurance_price, short_quote, description, is_active) VALUES (2, 'Hồn Quê Xứ Quảng', 'CULTURAL', 5800000, 12, '10 Giờ', 10.0, FALSE, 0, 'Lắng nghe nhịp điệu mộc mạc của đất mẹ và hồn quê xứ Quảng.', 'Hành trình chạm vào những điều bình dị mà sâu lắng của đất Quảng: từ những con phố rêu phong ở Hội An, hương đất nung bên dòng sông Thu Bồn đến vị mặn mòi của một làng rau lâu đời.', TRUE)");
        jdbcTemplate.execute("INSERT IGNORE INTO Tours (tour_id, tour_name, tour_type, base_price, max_capacity, duration, duration_hours, is_insurance_required, insurance_price, short_quote, description, is_active) VALUES (3, 'Hồn Đất Văn Lâm', 'CULTURAL', 6500000, 12, '10 Giờ', 10.0, FALSE, 0, 'Chạm vào hồn cốt của thời gian qua những tạo tác từ đôi bàn tay nghệ nhân.', 'Hành trình tìm về vẻ đẹp sơn thủy hữu tình của vùng đất cố đô cổ kính, nơi bạn được trò chuyện và cùng các nghệ nhân lưu giữ những làng nghề truyền thống trăm năm.', TRUE)");
        jdbcTemplate.execute("INSERT IGNORE INTO Tours (tour_id, tour_name, tour_type, base_price, max_capacity, duration, duration_hours, is_insurance_required, insurance_price, short_quote, description, is_active) VALUES (4, 'Thiền Giữa Hương Sen', 'RELAX', 8200000, 8, '10 Giờ', 10.0, FALSE, 0, 'Sự thanh lọc thuần khiết cho thân - tâm - trí giữa vùng sông nước mờ sương.', 'Một ngày trốn khỏi phố thị để về với đại đầm sen, mượn hương hoa và sóng nước miền Tây làm dịu lại tâm hồn, tìm lại sự bình an sâu lắng bên trong bạn.', TRUE)");
        jdbcTemplate.execute("INSERT IGNORE INTO Tours (tour_id, tour_name, tour_type, base_price, max_capacity, duration, duration_hours, is_insurance_required, insurance_price, short_quote, description, is_active) VALUES (5, 'Vịnh Xanh Kì Vĩ', 'ADVENTURE', 7500000, 15, '10 Giờ', 10.0, FALSE, 0, 'Du thuyền lướt nhẹ giữa ngàn khơi, thưởng ngoạn kỳ quan thiên nhiên rực rỡ.', 'Chuyến hải trình thong dong đưa bạn lướt qua những đảo đá nhấp nhô của vịnh Bắc Bộ, khám phá thế giới thạch nhũ kỳ vĩ được tạo hóa giấu kín ngàn năm và đón hoàng hôn buông trên mặt biển.', TRUE)");
        jdbcTemplate.execute("INSERT IGNORE INTO Tours (tour_id, tour_name, tour_type, base_price, max_capacity, duration, duration_hours, is_insurance_required, insurance_price, short_quote, description, is_active) VALUES (6, 'Sapa Mây Mù', 'ADVENTURE', 8200000, 10, '11 Giờ', 11.0, FALSE, 0, 'Gặp gỡ những nụ cười hồn hậu giữa vùng mây trời sương phủ.', 'Hành trình dạo bước qua những nấc thang ruộng bậc thang xanh mướt tại bản Cát Cát, tìm hiểu cuộc sống mộc mạc của đồng bào người H''Mông và lắng lại tâm hồn giữa núi rừng Tây Bắc.', TRUE)");
        jdbcTemplate.execute("INSERT IGNORE INTO Tours (tour_id, tour_name, tour_type, base_price, max_capacity, duration, duration_hours, is_insurance_required, insurance_price, short_quote, description, is_active) VALUES (7, 'Khám Phá Rừng Xanh', 'ADVENTURE', 9500000, 8, '14 Giờ', 14.0, FALSE, 0, 'Lắng nghe tiếng gọi thì thầm từ đại ngàn xanh thẳm.', 'Chuyến băng rừng rậm Nam Cát Tiên đầy cảm xúc, đưa bạn ghé thăm đầm lầy bảo tồn tự nhiên, thưởng thức bữa tối bên rừng và trải nghiệm ngắm thú đêm hoang dã.', TRUE)");
        jdbcTemplate.execute("INSERT IGNORE INTO Tours (tour_id, tour_name, tour_type, base_price, max_capacity, duration, duration_hours, is_insurance_required, insurance_price, short_quote, description, is_active) VALUES (8, 'Cát Vàng Mũi Né', 'ADVENTURE', 6500000, 10, '11 Giờ', 11.0, FALSE, 0, 'Đón những vệt nắng đầu ngày rực rỡ trên sa mạc cát mênh mông.', 'Trải nghiệm cảm giác phấn khích vượt đồi cát bằng xe ATV đón bình minh, khám phá dòng suối Tiên huyền thoại và thưởng thức mỹ vị biển khơi.', TRUE)");
        jdbcTemplate.execute("INSERT IGNORE INTO Tours (tour_id, tour_name, tour_type, base_price, max_capacity, duration, duration_hours, is_insurance_required, insurance_price, short_quote, description, is_active) VALUES (9, 'Đại Dương Phú Quốc', 'RELAX', 8500000, 12, '10 Giờ', 10.0, FALSE, 0, 'Hòa mình vào làn nước xanh lục bảo và vũ điệu rực rỡ dưới lòng đại dương.', 'Đồng hành cùng cano cao cấp lướt qua những hòn đảo hoang sơ, lặn ngắm rạn san hô đa sắc màu và tận hưởng bữa chiều ngắm hoàng hôn lãng mạn trên biển.', TRUE)");
        jdbcTemplate.execute("INSERT IGNORE INTO Tours (tour_id, tour_name, tour_type, base_price, max_capacity, duration, duration_hours, is_insurance_required, insurance_price, short_quote, description, is_active) VALUES (10, 'Sông Nước Cần Thơ', 'CULTURAL', 6800000, 12, '10 Giờ', 10.0, FALSE, 0, 'Tròn vị ngọt ngào của trái chín trĩu cành miền sông nước.', 'Đón bình minh trên chiếc ghe máy mộc mạc phục vụ riêng, hòa mình vào chợ nổi Cái Răng sầm uất, khám phá miệt vườn trĩu quả và học làm bánh dân gian Nam Bộ.', TRUE)");
