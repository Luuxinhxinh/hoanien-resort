...
(501, 501, 'VIP Nguy廙� V�n A', 'vipa@example.com', '0999888771', 'Nam', '001099000501', 52000, 4),
(502, 502, 'Normal Tr廕吵 B', 'normalb@example.com', '0999888772', 'N廙�', '001099000502', 95, 1),
(503, 503, 'Newbie L礙 C', 'newbiec@example.com', '0999888773', 'Nam', '001099000503', 0, 1),
(504, 504, 'Banned Ph廕《 D', 'bannedd@example.com', '0999888774', 'N廙�', '001099000504', 0, 1);
...
(501, 501, 'Wife Nguy廙� Th廙� B', '1995-08-15', 'V廙�', NULL, NULL),
(502, 501, 'Kid Nguy廙� V�n C', '2015-05-20', 'Con', NULL, NULL);
...
INSERT IGNORE INTO Room_Booking_Details (detail_id, room_booking_id, category_id, room_id, room_charge, detail_status, bed_preference, special_requests, is_charge_to_room_allowed, sub_credit_limit, billing_routing_strategy, customer_id) VALUES
(499, 499, 5, 15, 52000000, 'Checked_Out', 'KING_SIZE', 'Tu廕吵 tr�ng m廕負', TRUE, 5000000, 'BILL_TO_LEADER', 501);
...
INSERT IGNORE INTO Room_Booking_Details (detail_id, room_booking_id, category_id, room_id, room_charge, detail_status, bed_preference, special_requests, is_charge_to_room_allowed, sub_credit_limit, billing_routing_strategy, customer_id) VALUES
(501, 501, 3, 501, 10500000, 'Checked_In', 'KING_SIZE', 'G廕吵 thang m獺y', TRUE, 5000000, 'BILL_TO_LEADER', 501);
...
INSERT IGNORE INTO Room_Booking_Details (detail_id, room_booking_id, category_id, room_id, room_charge, detail_status, bed_preference, special_requests, is_charge_to_room_allowed, sub_credit_limit, billing_routing_strategy, customer_id) VALUES
(502, 502, 2, NULL, 1800000, 'Confirmed', 'TWIN_BED', 'Ph簷ng y礙n t藺nh', TRUE, 2000000, 'INDIVIDUAL', 502);
...
INSERT IGNORE INTO Room_Booking_Details (detail_id, room_booking_id, category_id, room_id, room_charge, detail_status, bed_preference, special_requests, is_charge_to_room_allowed, sub_credit_limit, billing_routing_strategy, customer_id) VALUES
(503, 503, 1, NULL, 5000000, 'Pending', 'KING_SIZE', '�p m瓊 gi廕σ s璽u', TRUE, 0, 'INDIVIDUAL', 502);
...
(501, 501, 501, 2, 'ROOM_SERVICE', 'RM801', 415000, 'PENDING', 'UNPAID', 'Ph簷ng 801 VIP'),
(502, 501, 501, 3, 'DINE_IN', 'T05', 500000, 'COOKING', 'UNPAID', '�t �獺'),
(503, 501, 501, 2, 'DINE_IN', 'T06', 85000, 'SERVED', 'UNPAID', 'Charge to room'),
(504, NULL, NULL, 3, 'DINE_IN', 'T07', 700000, 'PAID', 'PAID', 'Kh獺ch v瓊ng lai'),
(505, NULL, NULL, 2, 'DINE_IN', 'T08', 0, 'CANCELLED', 'UNPAID', 'Kh獺ch �廙飃 羸');
...
-- Folios linked
INSERT IGNORE INTO Folio_Items (folio_item_id, booking_id, room_booking_detail_id, payer_customer_id, source_department, amount, description, is_settled_separately, created_by_staff_id, created_at) VALUES 
(501, 501, 501, 501, 'LAUNDRY', 150000, 'Gi廕暗 廙告 VIP', FALSE, 4, CURRENT_TIMESTAMP),
(502, 501, 501, 501, 'FNB', 85000, 'Order Nh� h�ng T06 (SERVED)', FALSE, 2, CURRENT_TIMESTAMP);
...
INSERT INTO Room_Booking_Details (detail_id, room_booking_id, category_id, room_id, room_charge, detail_status, bed_preference, special_requests, is_charge_to_room_allowed, sub_credit_limit, billing_routing_strategy, number_of_adults, number_of_children) VALUES
(1031, 103, 8, NULL, 4500000, 'Pending', 'KING_SIZE', 'G?n thang m嫝', TRUE, 1000000, 'BILL_TO_LEADER', 2, 1),
(1032, 103, 8, NULL, 4500000, 'Pending', 'TWIN_BED', 'G?n ph犥g 26', TRUE, 1000000, 'BILL_TO_LEADER', 2, 1);

INSERT INTO Room_Guests (guest_id, detail_id, customer_id, dependent_id, guest_type, is_primary_contact) VALUES
(10311, 1031, 1, NULL, 'ADULT', TRUE),
(10312, 1031, NULL, 1, 'CHILD', FALSE), -- L� Ho跣g Minh
