...
INSERT IGNORE INTO Customers (customer_id, account_id, full_name, email, phone, gender, cccd_passport_encrypted, loyalty_points, customer_tier) VALUES
(501, 501, 'VIP Nguyen Van A', 'vipa@example.com', '0999888771', 'MALE', '001099000501', 52000, 'DIAMOND'),
(502, 502, 'Normal Tran B', 'normalb@example.com', '0999888772', 'FEMALE', '001099000502', 95, 'BRONZE'),
(503, 503, 'Newbie Le C', 'newbiec@example.com', '0999888773', 'MALE', '001099000503', 0, 'BRONZE'),
(504, 504, 'Banned Pham D', 'bannedd@example.com', '0999888774', 'FEMALE', '001099000504', 0, 'BRONZE');
...
(501, 501, 501, 2, 'ROOM_SERVICE', 'RM801', 415000, 'PENDING', 'UNPAID', 'Ph�ng 801 VIP'),
(502, 501, 501, 3, 'DINE_IN', 'T05', 500000, 'COOKING', 'UNPAID', '�t d�'),
(503, 501, 501, 2, 'DINE_IN', 'T06', 85000, 'SERVED', 'UNPAID', 'Charge to room'),
(504, NULL, NULL, 3, 'DINE_IN', 'T07', 700000, 'PAID', 'PAID', 'Kh�ch v�ng lai'),
(505, NULL, NULL, 2, 'DINE_IN', 'T08', 0, 'CANCELLED', 'UNPAID', 'Kh�ch d?i �');
