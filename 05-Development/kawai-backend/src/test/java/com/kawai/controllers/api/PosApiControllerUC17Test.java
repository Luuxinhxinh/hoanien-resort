...
/**
 * UC17 — Gọi món Dine-In tại quầy (Nhân viên POS lên đơn tại bàn)
...
public class PosApiControllerUC17Test {
    ...
    @Test
    @DisplayName("TC-M3-006 | UC17 | Dine-In — Tạo order thành công: ghi đúng bàn, số lượng, giá")
    ...
    @Test
    @DisplayName("TC-M3-006b | UC17 | Dine-In — Giá tại thời điểm gọi món (priceAtOrder) được lưu đúng")
    ...
    @Test
    @DisplayName("TC-M3-006c | UC17 | Dine-In — Ghi chú đặc biệt được lưu vào order")
    ...
    @Test
    @DisplayName("TC-M3-006d | UC17 | Dine-In — Thanh toán ngay tại POS: status PAID")
