...
* **Test File:** `DependentServiceUC16Test.java`
* **TDD Phase:** 🔴 RED
* **SRS Reference:** §2.1.16 Preconditions (Reservation phải Confirmed hoặc Checked_In)
...
* **Test File:** `DependentServiceUC16Test.java`
* **TDD Phase:** 🔴 RED
* **SRS Reference:** §2.1.16 E-02 Duplicate Guest Registration
...
* **Test File:** `DependentServiceUC16Test.java`
* **TDD Phase:** 🔴 RED
* **SRS Reference:** §2.1.16 E-01 Invalid Identification Document
...
* **Test File:** `DependentServiceUC16Test.java`
* **TDD Phase:** 🔴 RED
* **SRS Reference:** §2.1.16 AF-02 Additional Guest Added After Check-In
...
* **Test File:** `DependentServiceUC16Test.java`
* **TDD Phase:** 🔴 RED
* **Legal:** Nghị định 13/2023/NĐ-CP — BR-SYS-01
...
|----|-------|------------|-----------|--------|-----------|---------|----------|-----------|---------|-------------|-----------|---------|
| UC16 | TC-UC16-001 | Đăng ký dependent mới thành công | `DependentServiceUC16Test.java` | [ ] | | | [ ] | | | [ ] | | |
| UC16 | TC-UC16-002 | Booking Cancelled → từ chối | `DependentServiceUC16Test.java` | [ ] | | | [ ] | | | [ ] | | |
| UC16 | TC-UC16-003 | Trùng CCCD → DuplicateException | `DependentServiceUC16Test.java` | [ ] | | | [ ] | | | [ ] | | |
| UC16 | TC-UC16-004 | CCCD không hợp lệ → InvalidIdException | `DependentServiceUC16Test.java` | [ ] | | | [ ] | | | [ ] | | |
| UC16 | TC-UC16-005 | Booking Checked_In → thành công | `DependentServiceUC16Test.java` | [ ] | | | [ ] | | | [ ] | | |
| UC16 | TC-UC16-009 | PII CCCD mã hoá AES-256 (không plaintext) | `DependentServiceUC16Test.java` | [ ] | | | [ ] | | | [ ] | | |
| UC16 | TC-UC16-010 | bookingId không tồn tại → 404 | `DependentServiceUC16Test.java` | [ ] | | | [ ] | | | [ ] | | |
