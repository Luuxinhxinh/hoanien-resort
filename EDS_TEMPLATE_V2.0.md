...
3. Architecture Decision Records (ADR) ⭐ Mới
4. Non-Functional Requirements & SLA ⭐ Mới
5. Static Modeling (Mô hình Tĩnh)
6. Dynamic Modeling (Mô hình Động)
7. Domain Event Catalog ⭐ Mới
8. Interface Specification (Đặc tả Giao diện)
9. API Specification
10. Bảng mã lỗi (Error Codes)
11. Quy trình Triển khai (Step-by-Step)
12. Rollback & Incident Runbook ⭐ Mới
...
*(Chèn hình ảnh sơ đồ PlantUML mô tả Entity, Value Object, Service, Repository)*
...
*(Chèn sơ đồ trình tự cho luồng xử lý thành công)*

### 6.2. Sequence Diagram — Error Path (PlantUML)

*(Chèn sơ đồ trình tự cho luồng xử lý lỗi)*

### 6.3. State Machine *(bắt buộc nếu module có trạng thái)*

*(Chèn sơ đồ trạng thái mô tả vòng đời của Entity)*
