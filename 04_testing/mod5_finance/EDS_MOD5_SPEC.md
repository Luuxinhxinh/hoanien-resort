...
| Field | Value |
| --- | --- |
| **Module Name** | `Hóa đơn tổng hợp & Kiểm toán đêm` |
| **Bounded Context** | `Hóa đơn tổng hợp & Kiểm toán đêm` |
...
### 🔹 API 001: Lấy báo cáo dư nợ tổng hợp (Get Folio Summary)
- **HTTP Method:** `GET`
- **URL Path:** `/api/v1/folios/{id}`
...
| :--- | :--- | :--- | :--- |
| MOD5-001 | 400 | "Dữ liệu không hợp lệ" | Đầu vào thiếu trường bắt buộc |
| MOD5-002 | 404 | "Không tìm thấy tài nguyên" | ID tìm kiếm không tồn tại |
...
| --- | --- | --- | --- | --- |
| `MOD5-001` | 400 | Validation failed | Dữ liệu không hợp lệ | [Khi nào xảy ra] |
| `MOD5-002` | 409 | Resource conflict | Xung đột tài nguyên | [Khi nào xảy ra] |
| `MOD5-003` | 404 | Resource not found | Không tìm thấy | [Khi nào xảy ra] |
| `MOD5-004` | 403 | Insufficient permissions | Không đủ quyền | [Khi nào xảy ra] |
| `MOD5-005` | 500 | Internal error | Lỗi hệ thống | [Khi nào xảy ra] |
...
*   **Scenario: [Unauthorized access]**
    ...
    *   And response body chứa error code `MOD5-004`
