...
| --- | --- | --- | --- | --- | --- |
| TC-M2-001 | Tìm phòng trống đúng theo ngày nhận/trả | TBD | [x] | [x] | |
| TC-M2-002 | Không có phòng trống → trả danh sách rỗng | TBD | [x] | [x] | |
| TC-M2-003 | Đặt phòng thành công — tạo Booking + Folio trống | TBD | [x] | [x] | |
| TC-M2-004 | 2 user đặt cùng phòng cùng lúc → 1 thành công, 1 trả 409 (Pessimistic Lock) | TBD | [x] | [x] | |
| TC-M2-005 | Thanh toán cọc VNPay → callback xác nhận → trạng thái Booking = CONFIRMED | TBD | [x] | [x] | |
| TC-M2-006 | Hủy trước 48h → hoàn 100% cọc (BR-FIN-02) | TBD | [x] | [x] | |
| TC-M2-007 | Hủy trong 48h → tịch thu cọc (BR-FIN-02) | TBD | [x] | [x] | |
| TC-M2-008 | Áp mã khuyến mãi hợp lệ → giảm giá đúng | TBD | [x] | [x] | |
| TC-M2-009 | Mã khuyến mãi hết hạn / sai → từ chối | TBD | [x] | [x] | |
| TC-M2-010 | Dashboard trả đúng danh sách phòng + trạng thái thời gian thực | TBD | [x] | [x] | |
| TC-M2-011 | Check-in thành công — phòng chuyển OCCUPIED, tạo Folio | TBD | [x] | [x] | |
| TC-M2-012 | Check-in thất bại — phòng đang DIRTY hoặc MAINTENANCE → báo lỗi | TBD | [x] | [x] | |
| TC-M2-013 | Ủy quyền hạn mức — cập nhật Credit Limit thành công | TBD | [x] | [x] | |
| TC-M2-014 | Đổi phòng — chuyển Folio sang phòng mới, phòng cũ → DIRTY | TBD | [x] | [x] | |
| TC-M2-015 | Nâng cấp Dependent thành Customer — tạo Account mới | TBD | [x] | [x] | |
| TC-M2-016 | Check-out → tự động sinh yêu cầu dọn phòng (Trigger DB) | TBD | [x] | [x] | |
| TC-M2-017 | Housekeeping cập nhật phòng DIRTY → CLEAN | TBD | [x] | [x] | |
| TC-M2-018 | Lễ tân xem danh sách yêu cầu dọn/sửa phòng | TBD | [x] | [x] | |
| TC-M2-019 | Housekeeping tạo phiếu sửa chữa → phòng chuyển MAINTENANCE | TBD | [x] | [x] | |
| TC-M2-020 | Maintenance hoàn thành → phòng chuyển AVAILABLE | TBD | [x] | [x] | |
