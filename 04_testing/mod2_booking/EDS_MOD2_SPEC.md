...
### 🔹 API 001: Tìm phòng trống (Search Rooms)
- **HTTP Method:** `POST`
- **URL Path:** `/api/v1/rooms/search`
...
| :--- | :--- | :--- | :--- |
| MOD2-001 | 400 | "Dữ liệu không hợp lệ" | Đầu vào thiếu trường bắt buộc |
| MOD2-002 | 404 | "Không tìm thấy tài nguyên" | ID tìm kiếm không tồn tại |
...
| --- | --- | --- | --- | --- |
| `MOD2-001` | 400 | Validation failed | Dữ liệu không hợp lệ | [Khi nào xảy ra] |
| `MOD2-002` | 409 | Resource conflict | Xung đột tài nguyên | [Khi nào xảy ra] |
| `MOD2-003` | 404 | Resource not found | Không tìm thấy | [Khi nào xảy ra] |
| `MOD2-004` | 403 | Insufficient permissions | Không đủ quyền | [Khi nào xảy ra] |
| `MOD2-005` | 500 | Internal error | Lỗi hệ thống | [Khi nào xảy ra] |
...
*   **Scenario: [Unauthorized access]**
    ...
    *   And response body chứa error code `MOD2-004`
