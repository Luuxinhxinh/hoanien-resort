...
| --- | --- | --- |
| 2026-06-12 | `Nguyễn Xuân Lưu` | Khởi tạo tài liệu — TDD spec cho Xác thực, 2FA & Bảo mật PII |
...
| --- | --- | --- | --- |
| **TC-COND-001** | *(điều kiện nghiệp vụ)* | *(method / class / API endpoint)* | `MOD1-TC-001` |
| **TC-COND-002** | | | |
...
#### `MOD1-TC-INT-001` — [Tên scenario end-to-end]
...
| --- | --- | :---: | --- | --- |
| `MOD1-TC-001` | `[path].spec.ts:line` | `[ ]` | `[hash]` | *(extract method, typing, etc.)* |
