...
| --- | --- | --- | --- | --- | --- |
| TC-M4-001 | Tìm kiếm tour — trả danh sách tour khả dụng + thông tin thời tiết | TBD | [x] | [x] | |
| TC-M4-002 | API thời tiết không phản hồi → vẫn trả tour, ẩn thông tin thời tiết | TBD | [x] | [x] | |
| TC-M4-003 | Đặt tour thành công — tạo bản ghi Tour_Attendees | TBD | [x] | [x] | |
| TC-M4-004 | Tour hết slot — đặt thêm bị chặn, trả TOUR-001 | TBD | [x] | [x] | |
| TC-M4-005 | Đặt tour Post to Room — ghi nợ vào Folio phòng | TBD | [x] | [x] | |
| TC-M4-006 | Lập lịch chuyến tour — gán xe, tài xế, Tour Guide | TBD | [x] | [x] | |
| TC-M4-007 | Hủy tour — hoàn tiền theo chính sách hoặc đổi lịch | TBD | [x] | [x] | |
| TC-M4-008 | Gửi ảnh → AI Service trả match → Tour_Attendees cập nhật PRESENT | TBD | [x] | [x] | |
| TC-M4-009 | AI Service không khả dụng → cho phép điểm danh thủ công | TBD | [x] | [x] | |
| TC-M4-010 | Khách gửi đánh giá 1-5 sao + nội dung text | TBD | [x] | [x] | |
| TC-M4-011 | Chỉ khách đã sử dụng dịch vụ mới được đánh giá | TBD | [x] | [x] | |
| TC-M4-012 | Admin ẩn/hiện đánh giá toxic/spam | TBD | [x] | [x] | |
