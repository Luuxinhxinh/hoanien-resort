...
| Field | Value |
| --- | --- |
| **Module Name** | `POS Nhà hàng & Dịch vụ phòng` |
| **Bounded Context** | `POS Nhà hàng & Dịch vụ phòng` |
...
### 🔹 API 001: Ký gửi hóa đơn về phòng (Post to Room)
- **HTTP Method:** `POST`
...
| :--- | :--- | :--- | :--- |
| MOD3-001 | 400 | "Dữ liệu không hợp lệ" | Đầu vào thiếu trường bắt buộc |
| MOD3-002 | 404 | "Không tìm thấy tài nguyên" | ID tìm kiếm không tồn tại |
...
| --- | --- | --- | --- | --- |
| `MOD3-001` | 400 | Validation failed | Dữ liệu không hợp lệ | [Khi nào xảy ra] |
| `MOD3-002` | 409 | Resource conflict | Xung đột tài nguyên | [Khi nào xảy ra] |
| `MOD3-003` | 404 | Resource not found | Không tìm thấy | [Khi nào xảy ra] |
| `MOD3-004` | 403 | Insufficient permissions | Không đủ quyền | [Khi nào xảy ra] |
| `MOD3-005` | 500 | Internal error | Lỗi hệ thống | [Khi nào xảy ra] |
...
*   **Scenario: [Unauthorized access]**
    ...
    *   And response body chứa error code `MOD3-004`
