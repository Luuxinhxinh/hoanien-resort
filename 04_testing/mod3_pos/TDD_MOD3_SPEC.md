...
| --- | --- | --- |
| 2026-06-12 | `Nguyễn Xuân Lưu` | Khởi tạo tài liệu — TDD spec cho POS Nhà hàng & Dịch vụ phòng |
...
| Field | Value |
| --- | --- |
| **Feature / Gap ID** | `GAP-MOD3` |
| **Module** | `POS Nhà hàng & Dịch vụ phòng` |
| **Spec gốc** | `KAWAI-EDS-MOD3-001` |
| **Priority** | 🟠 P1 |
...
| --- | --- | --- | --- |
| **TC-COND-001** | *(điều kiện nghiệp vụ)* | *(method / class / API endpoint)* | `MOD3-TC-001` |
| **TC-COND-002** | | | |
...
#### `MOD3-TC-INT-001` — [Tên scenario end-to-end]
...
| --- | --- | :---: | --- | --- |
| `MOD3-TC-001` | `[path].spec.ts:line` | `[ ]` | `[hash]` | *(extract method, typing, etc.)* |
